...
public class GrowshopApplication {
    ...
    public CommandLineRunner initData(ClienteRepositorio clienteRepositorio, ProductoRepositorio productoRepositorio, OrdenRepositorio ordenRepositorio, PagoRepositorio pagoRepositorio, OrdenProductoRepositorio ordenProductoRepositorio) {
        return (args) -> {
            ...
            Producto producto1 = new Producto("Encendedor","Bic", "Encendedor de plastico BIC", 250, Categoria.ACCESORIOS,"Encendedores","https://mayoristasoto.com/4503-medium_default/encendedor-bic-maxi-1u.jpg", 40, true);
            Producto producto2 = new Producto("Pica","Lion Rolling Circus", "Picador rolling circus", 330, Categoria.ACCESORIOS,"Picadores","https://yenex.com.ar/wp-content/uploads/2021/12/Picador-metalico-de-3-partes-Amsterdam-LION-ROLLING-CIRCUS.jpg", 6, true);
            Producto producto3 = new Producto("Liyo","OCB", "Liyos de celulosa", 125, Categoria.ACCESORIOS,"Sedas","https://i0.wp.com/cogolloshermanos.com/wp-content/uploads/2021/06/sedas-ocb.jpg?fit=640%2C640&ssl=1", 20, true);

            ////////// TABACOS //////////
            Producto cerritoOriginal = new Producto("Tabaco Cerrito Original 40gr","Cerrito", "Tabaco Cerrito es un blend de diferentes variedades de tabaco virginia. Se caracteriza mayormente por una humedad perfecta para poder manipularlo de manera más sencilla y un sabor y aroma muy equilibrados.", 1250, Categoria.TABACO,"Tabaco","https://parainfernalia.com.ar/wp-content/uploads/2019/04/tabaco-cerrito-original-45gr-growshop.png", 25, true);
            ...
            Producto lasHojas = new Producto("Tabaco Las Hojas x50gr", "Las Hojas", "Tabaco Las hojas es un tabaco natural de intensidad intermedia ideal para quienes gustan del clásico tabaco rubio. Todas las variedades de Las Hojas están hechas con la máxima calidad en la selección del tabaco, por eso es uno de los mejores del mercado. En este caso, su paquete por 50gr. Permita que puedas disfrutar por mucho más tiempo de su sabor.", 700, Categoria.TABACO,"Tabaco","https://parainfernalia.com.ar/wp-content/uploads/2017/04/TABACO-LAS-HOJAS-30gr-PI-ARGENTINA.png", 10, true);
            Producto lasHojasNatural = new Producto("Tabaco Las Hojas Natural x30gr", "Las Hojas", "Tabaco Las hojas Natural es un tabaco producido sin utilizar ningún tipo de químico o aditivo durante su proceso. Con una intensidad intermedia, esta variedad de tabaco Las Hojas es de un sabor muy agradable para quienes prefieren cigarrillos más suaves, además está empacado especialmente para que mantenga la frescura y humedad necesaria.", 1300, Categoria.TABACO,"Tabaco","https://parainfernalia.com.ar/wp-content/uploads/2017/04/TABACO-LAS-HOJAS-30gr-PI-ARGENTINA.png", 5, true);
            ...
            Producto carpaCultivArg = new Producto("Carpa Eco 60x60x160", "CultivArg", "Modelo: ECO 60x60x160\n" +
                    ...
                    "Estructura de la carpa: Tubos de metal de 17 mm", 45000, Categoria.CULTIVO,"Carpas","https://http2.mlstatic.com/D_NQ_NP_891863-MLA46478777620_062021-O.webp", 3, true);
            Producto premiumCultivArg = new Producto("Carpa Eco 80x80x180", "CultivArg", "Modelo: ECO 80x80x180\n" +
                    ...
                    "Tamaño: 80 x 80 x 180 cm\n" +
                    "Mylar 480D 98% Reflex\n" +
                    "Estructura de la carpa: Tubos de metal de 17 mm", 71000, Categoria.CULTIVO,"Carpas","https://http2.mlstatic.com/D_NQ_NP_843282-MLA44395719319_122020-O.webp", 2, true);
            Producto highPro1 = new Producto("Carpa Pro Box 80x80x160", "Garden Highpro","Indoor de excelente calidad, ideal para cultivo en espacios amplios y para una producción individual de gran rendimiento.\n" +
                    ...
                    "\n" +
                    "Ventana rejilla trasera inferior de 25 x 12.5 cm", 66500, Categoria.CULTIVO,"Carpas", "https://http2.mlstatic.com/D_NQ_NP_903434-MLA70421174515_072023-O.webp", 1, true);
            Producto highPro2 = new Producto("Carpa Pro Box 120x120x200", "Garden Highpro","Carpa 120x120\n" +
                    ...
                    "• Caja cerrada." ,86000, Categoria.CULTIVO,"Carpas","https://http2.mlstatic.com/D_NQ_NP_903434-MLA70421174515_072023-O.webp", 2, true );
            Producto vidaCultiva1 = new Producto("Carpa Vida Cultiva 80x80x160", "Vida Cultiva", "DESCRIPCIÓN DEL PRODUCTO\n" +
                    ...
                    "HIDROPONIA: 2 baldes de 25L", 57500, Categoria.CULTIVO,"Carpas","https://http2.mlstatic.com/D_NQ_NP_863829-MLA53765721026_022023-O.webp", 1, true);
            Producto vidaCultiva2 = new Producto("Carpa Vida Cultiva 120x120x200", "Vida Cultiva", "DESCRIPCIÓN DEL PRODUCTO\n" +
                    ...
                    "- Esquinero\n" +
                    "- Bandeja Removible\n" +
                    "- Cintas para luces", 78000, Categoria.CULTIVO,"Carpas","https://http2.mlstatic.com/D_NQ_NP_950916-MLA54983861584_042023-O.webp", 1, true);
            //Sustratos//
            Producto growMix80 = new Producto("Sustrato GrowMix 80lt","GrowMix", "ustrato Profesional Grow Mix MULTIPRO Fertilizado x 80lts - Terrafertil\n" +
                    ...
                    ". Agentes humectantes.\n" +
                    "\n" +
                    "(N) 200-270 (P) 15-40 (K) 200-300\n", 6900, Categoria.CULTIVO,"Sustratos","https://http2.mlstatic.com/D_NQ_NP_768961-MLA47845752128_102021-O.webp", 10, true);
            Producto growMix20 = new Producto("Sustrato GrowMix 20lt","GrowMix", "SUSTRATO PROFESIONAL GROW MIXTA DE 20 LITROS TERRAFERTIL\n" +
                    ...
                    "Vivero Plantas Al Natural", 2500, Categoria.CULTIVO,"Sustratos","https://http2.mlstatic.com/D_NQ_NP_875199-MLA44685606693_012021-O.webp", 3, true);
            Producto terraFertil = new Producto( "Sustrato Huertas Terrafertil X 50 L", "Terrafertil", "Huertas\n" +
                    ...
                    "\n" +
                    "Componentes:\n" +
                    "Turba de Musgo Shagnum de fibras finas y medias, Compost de Poda Urbana, Perlita, Dolomita, Fertilizantes", 4200, Categoria.CULTIVO, "Sustratos","https://http2.mlstatic.com/D_NQ_NP_823510-MLA44135856596_112020-O.webp", 4, true);
            Producto cultivatePremium = new Producto("Sustrato Cultivate Premium 80Lts", "Cultivate", "Composición:\n" +
                    ...
                    "Contiene los nutrientes que la planta consumirá en los primeros meses de vida.", 5600, Categoria.CULTIVO, "Sustratos","https://http2.mlstatic.com/D_NQ_NP_774215-MLA51560073338_092022-O.webp", 4, true);
            //Fertilizantes//
            Producto namasteOroNegro = new Producto("Oro Negro Namasté","Namasté", "ORO NEGRO - NAMASTE\n" +
                    ...
                    "Se puede aplicar de manera foliar, intercalando con los riegos. No mezclar este producto en el mismo riego con otros productos.", 4250, Categoria.CULTIVO,"Fertilizantes","https://http2.mlstatic.com/D_NQ_NP_808297-MLA70696536868_072023-O.webp", 34, true);
            Producto namasteFloraBooster = new Producto("Flora Booster Namasté","Namasté", "FLORA BOOSTER\n" +
                    ...
                    "del agua usada habitualmente en el riego.", 4250, Categoria.CULTIVO,"Fertilizantes","https://http2.mlstatic.com/D_NQ_NP_756652-MLA51811963886_102022-O.webp", 21, true);
            ...
            Producto namasteDetox = new Producto("Detox 600ml Namaste", "Namasté", "Namaste Detox Lavador de raíces natural\n" +
                    ...
                    "Caso contrario no sentiremos el aroma propio de la flor y sí sabor a los excedentes, no barridos, de productos que hayamos usado para nutrirla previamente.", 3100, Categoria.CULTIVO, "Fertilizantes","https://http2.mlstatic.com/D_NQ_NP_846910-MLA47966602467_102021-O.webp", 9, true);
            Producto topCropVeg = new Producto("Top Veg Top Crop Crecimiento 250 Ml", "Top Crop", "Fertilizante líquido completo rico en ácidos húmicos y fúlvicos así como en macro y micronutrientes solubles en agua.\n" +
                    ...
                    "Usos y aplicaciones:\n" +
                    "\n" +
                    "Diluir a razón de 2-4ml por cada litro de agua una vez por semana.", 2000, Categoria.CULTIVO, "Fertilizantes","https://http2.mlstatic.com/D_NQ_NP_620058-MLA50007181073_052022-O.webp", 2, true);
            Producto topCropFlora = new Producto("Top Bloom 250ML Floracion", "Top Crop", "Es un fertilizante de floración rico en fósforo y potasio para desarrollar flores gruesas y compactas, además estimula el comienzo de la floración. Está formulado con ácidos húmicos de elevada actividad natural orgánica. Su rápida absorción lo convierte en ideal por sus resultados casi inmediatos y su alto contenido en nutrientes hace innecesario el aporte adicional de P-K(fósforo y potasio).", 2400, Categoria.CULTIVO, "Fertilizantes","https://http2.mlstatic.com/D_NQ_NP_807007-MLA47805387058_102021-O.webp", 10, true);
            //Macetas//
            Producto happyRoots = new Producto("Maceta Reforzada Geotextil 60 Litros", "Happy Roots","Antidesgarro - Protección UV (Resiste la exposición solar)\n" +
                    ...
                    "Jardines verticales\n" +
                    "Huertas Rectangulares y circulares", 1800, Categoria.CULTIVO, "Macetas","https://http2.mlstatic.com/D_NQ_NP_716977-MLA52575590539_112022-O.webp", 5, true);
            Producto happyRoots2 = new Producto("Maceta Reforzada Geotextil 150litros", "Happy Roots", "Antidesgarro - Protección UV (Resiste la exposición solar)\n" +
                    ...
                    "\n" +
                    "Todo tipo de trabajos a medida", 2800, Categoria.CULTIVO, "Macetas","https://http2.mlstatic.com/D_NQ_NP_716977-MLA52575590539_112022-O.webp", 2, true);
            Producto happyRoots3 = new Producto("Maceta Reforzada Tela Geotextil 3Litros", "Happy Roots", "Antidesgarro - Protección UV (Resiste la exposición solar)\n" +
                    ...
                    "Huertas Rectangulares y circulares\n" +
                    "\n" +
                    "Todo tipo de trabajos a medida", 600, Categoria.CULTIVO,"Macetas","https://http2.mlstatic.com/D_NQ_NP_700885-MLA45346695549_032021-O.webp", 25,true);
            Producto madRocket = new Producto("Maceta Mad Rocket 5l Autopoda Indoor", "Mad Rocket", "Su diseño único de gran altura nos permite formar una raíz madre fuerte.\n" +
                    ...
                    "- Todos los modelos son tanto para indoor como para exterior.", 1200, Categoria.CULTIVO, "Macetas","https://http2.mlstatic.com/D_NQ_NP_634389-MLA51889125435_102022-O.webp", 11, true);
            Producto madRocket2 = new Producto("Maceta Mad Rocket 16 Litros", "Mad Rocket", "Las MAD ROCKET cuentan con guiadores que llevan a las raíces hacia las ventanas de auto-poda radicular aérea que provocan que en la punta de las raíces se genere un callo para hacer que de esta misma raíz nazcan nuevos brazos y así estimular el desarrollo radicular colonizando todo el pan de sustrato.\n" +
                    ...
                    "- Cuenta con todos los modelos Mad Rocket: 5L, 10L, 16L y 25L.", 2100,Categoria.CULTIVO, "Macetas","https://http2.mlstatic.com/D_NQ_NP_634389-MLA51889125435_102022-O.webp", 19, true );
            //Herramientas//
            Producto kitJardineria = new Producto("Kit Jardineria 8 Piezas", "Tramontina", "// INCLUYE //\n" +
                    ...
                    "• 1 tijera de podar\n" +
                    "• 1 par de guantes\n" +
                    "• 1 cinturón", 15000, Categoria.CULTIVO, "Herramientas","https://http2.mlstatic.com/D_NQ_NP_736800-MLA49646543972_042022-O.webp", 3, true);
            Producto kitJardineria2 = new Producto("Kit Para Jardin Tramontina","Tramontina","Kit para jardin Tramontina Mango de Madera\n" +
                    ...
                    "- Los mangos de estas herramientas, además de tener excelente resistencia, son producidos con madera de origen renovable.",2400,Categoria.CULTIVO,"Herramientas","https://http2.mlstatic.com/D_NQ_NP_856124-MLA47661520259_092021-O.webp",1,true);
            Producto poleas = new Producto("Poleas Panel De Cultivo Indoor 68 Kg.", "Bellavita", "*Características:\n" +
                    ...
                    "1 metro de largo y capacidad máxima 68 Kg.", 4100, Categoria.CULTIVO, "Herramientas","https://http2.mlstatic.com/D_NQ_NP_790267-MLA54988105824_052023-O.webp", 14, true);
            Producto poleas1 = new Producto("Poleas Bellavita Plástico Resistente 5 Kgs Indoor","Bellavita","", 2700, Categoria.CULTIVO, "Herramientas","https://http2.mlstatic.com/D_NQ_NP_780200-MLA69443257523_052023-O.webp", 2, true);
            //Insecticidas//
